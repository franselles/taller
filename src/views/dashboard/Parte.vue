    ...
    <form>
      <div class="columns">
        ...
        <div class="column is-3">
          ...
          <div class="control">
            <input id="fecha" name="fecha" type="date" class="input" v-model="parte.fecha">
      ...
      <div class="columns">
        <div class="column">
          ...
          <table name="reparacion" class="table is-responsive is-striped">
            ...
            <tbody>
              <tr v-for="(reparacion, index) in parte.reparacion" :key="reparacion.linea">
                ...
                <td>
                  <a class="button is-success" @click="editarReparacion(reparacion)">
                    <span class="icon">
...
export default {
  ...
  methods: {
    ...mapMutations("partes", ["setParte", "setReparacion", "setNuevoParte"]),
    ...mapActions("partes", [
      "addParte",
      "updateParte",
      "getPartes",
